...
class SourceTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_source = Source("Associated Press","general","The AP delivers in-depth coverage on the international, politics, lifestyle, business, and entertainment news.","en")
